...
/*!
 * Generated using the Bootstrap Customizer (https://getbootstrap.com/docs/3.3/customize/?id=4db1cecfc5d9659ec81d319f1eda7a3b)
 * Config saved to config.json and https://gist.github.com/4db1cecfc5d9659ec81d319f1eda7a3b
 */
...
$(document).ready(function () {
  ...
  $('.__click_here').click(function () {
    $('.__questions_wrapper').slideToggle(700);
  });

  $('#trigger_leadForm').click(function () {
    $('.__lead_dropdown').toggle();
    $(this).toggleClass("closeMe");
  });
  $('.__lead_dropdown,#trigger_leadForm').click(function (event) {
    event.stopPropagation();
  })
  $(window).click(function () {
    $('.__lead_dropdown').fadeOut(100);
  });

  /* Jquery Enquiry Form Validation */
  $("#enq_form").validate({
    errorPlacement: function (error, element) {
      if (element.attr("name") == "first_name")
        error.insertAfter("#f_name_frm");
      else if (element.attr("name") == "last_name")
        error.insertAfter("#l_name_frm");
      else if (element.attr("name") == "phone_number")
        error.insertAfter("#phone_frm");
      else if (element.attr("name") == "country_code")
        error.insertAfter("#phone_frm");
      else if (element.attr("name") == "email")
        error.insertAfter("#email_frm");
    ...
    messages: {
      ...
      enq_services: "Select at least 1 Service",
      country_code: "Enter Valid Country Code"
    },
    submitHandler: function () {
      var fd = $("#enq_form").serialize();
