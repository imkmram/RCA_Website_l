...
class SrilankaApplicationController extends ApplicationController {
	...
	public function srilankaEvisaApplicationForm(Request $request){
		...
		return view('srilanka/srilanka_visa_application', compact('ccode','getpostdata','getservice','getmarital','data_name','country_arr','gettouristpurpose','getbusinesspurpose','gettransitpurpose'));
}
			...
			if($ordid){
				...
				$applicant_id = ApplicantProfiles::select(DB::raw('max(profile_id) as profile_id'))->get()->first();
					...
					$res_arr = array(
						...
						'tourist_purpose' => !empty($getrequest['purpose_of_visit_tourist'])?$getrequest['purpose_of_visit_tourist']:NULL,
			        	'business_purpose' => !empty($getrequest['purpose_of_visit_business'])?$getrequest['purpose_of_visit_business']:NULL,
			        	...
			        	'transit_purpose' => !empty($getrequest['purpose_of_visit_transit'])?$getrequest['purpose_of_visit_transit']:NULL,
						...
						'port_of_departure'=> !empty($getrequest['port_of_departure'])?$getrequest['port_of_departure']:NULL,
