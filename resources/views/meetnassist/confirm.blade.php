                ...
                <div class="col-md-12">
                    <div class="paddingtb_50">
                        ...
                        <div class="tabs_z_content __current">
                            <div class="row">
                                <div class="col-md-12">
                                    <h1 class="__main_heading"><a href="{{ URL::to('/') }}"><img src="svg/arrow-left.svg" alt="" width="15" /> MEET & GREET BOOKING</a></h1>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-8">
...
@if($product_price->rate_application == 'Per Person')
<div class="__order_row">
    ...
    @if($mna_child_passengers != 0 && $product_price->c_total_sp_usd_with_gst>0)
    <div class="__order_row">
...
<div class="__order_row">
    <div class="__order_lft">
         Adult : {{$mna_adult_passengers}} X {{round($product_price->total_sp_usd_with_gst)}}
    </div>
    <div class="__order_rgt">
{{round($product_price->total_sp_usd_with_gst) * $mna_adult_passengers}}
    </div>
    <?php $total_a_usd = (round($product_price->total_sp_usd_with_gst) * $mna_adult_passengers); 
    $total_a = (round($product_price->total_sp_inr_with_gst) * $mna_adult_passengers);
    ?>
...
<div class="__order_row">
    ...
    <?php echo $product_price->total_sp_usd_with_gst;
    $total += round($product_price->total_sp_inr_with_gst); 
    $total_usd += round($product_price->total_sp_usd_with_gst); 
...
@endforeach
			...
			<div class="__round_wrapper __frm_gutter">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <div class="__form_inline">
                                        ...
                                        <div class="__frm_grp">
                                            <div class="__label" style="font-size:50"> <?php echo $x; ?></div>
                                        </div>
                                        <div class="__frm_grp">
                                ...
                                <div class="col-md-5">
                                    <div class="__order_summary">
                                        ...
                                        <div class="__inline_100">
                                            <input id="all" name="same_ticket_<?php echo $x; ?>" type="checkbox" class="__checkbox same_ticket_mna"> <!-- RCAV1-56 -->
                        ...
                        <?php } ?>
                            ...
                            <div class="paddingtb_10 text-center"><button type="submit" class="__btn __active proceed_payment_btn">PROCEED</button></div>
