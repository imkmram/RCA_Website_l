...
<!-- End Ticker -->
<!-- Header with Nav -->
<header class="__sd_header">
<div class="__ticker">RedCarpet Assist’s Festive Offer - Buy 3 Visas. Get 1 Visa Free.</div>
    <nav class="__sd_nav">
        <ul class="__ul">
            ...
            <li class="__sd_user"><a>Our Products</a>
                    <ul class="__dropdown">
                        <li class="__subdrop"><a href="{{ url('evisa/') }}">eVisa</a>
                            <ul class="__sub_dropdown">
                                ...
                                <li><a href="{{ url('evisa/malaysia') }}" {{{ (Request::is('/evisa/malaysia') ? 'class=active' : '') }}}">eVisa Malaysia</a></li>
            ...
            <li class="ShowInMobile">
                <a  target="_blank" href="{{ url('sitemap') }}" {{{ (Request::is('sitemap') ? 'class=active' : '') }}}>Sitemap</a>
            </li>
            <li class="ShowInMobile">
