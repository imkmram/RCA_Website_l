    ...
    <div class="__typ_wrapper">
        <div class="__typ_container">
            <div class="__typ_form">
                <div class="upform">
                    <form method="post" name="CustomTypeFormForSrilanka" id="CustomTypeFormForSrilanka" novalidate action="{{URL::to('/')}}/srilanka-form/to/{{$extractdata['order_id']}}">
                        <input type="hidden" name="nationality" value="{{$extractdata['nationality']}}">
                        ...
                        <div class="upform-main parent-counter upform-main-srilanka">
                            <div class="input-block">
                                ...
                                <div class="input-control outerInFoc">
                                    <input type="text" placeholder="Select an option" name="travel_type_text" id="travel_type_text" class="__select_drop inputF" autocomplete="off" value="{{$extractdata['travel_type_text']}}">
                                    <ul class="hiddenul">
                            ...
                            <div class="input-block">
                                ...
                                <div class="input-control outerInFoc">
                                    <input type="text" placeholder="Select an option" name="salutation_text" class="__select_drop inputF" autocomplete="off" value="{{$extractdata['application_details']['salutation_text']}}">
                                    <ul class="hiddenul">
                                    ...
                                    <input type="hidden" id="salutation" name="salutation" class="inputH" value="{{isset($extractdata['application_details']['salutation']) ? $extractdata['application_details']['salutation'] : NULL}}">
                                    <div class="press_enter">PRESS TAB</div>
                                </div>
                                <div class="outerclick"></div>
                            </div>
                            <div class="input-block active">
                                ...
                                <div class="input-control">
                                    <input type="text" name="passport_given_name" id="passport_given_name" value = "{{$extractdata['username']}}" required="" />
                            ...
                            <div class="input-block active">
                                ...
                                <div class="input-control">
                                    <input type="text" name="passport_surname_name" id="passport_surname_name" value = "{{$extractdata['surname']}}" required="" />
                                    <div class="press_enter">PRESS ENTER</div>
                                </div>
                            </div> 
                            <div class="input-block">
                                <div class="labels">
                                    <div class="qs_list block-counter"></div>
                                    <div class="qs_body">Hey <span id="passport_mapping">{{$extractdata['username']}}</span>, enter your valid passport number <span class="strike">*</span>
                                    <!-- <div class="qs_sub">Something like A00000000</div> -->
                                    </div>
                                </div>
                                <div class="input-control">
                                    <input type="text" name="passport_number" id="passport_number" value="{{$extractdata['pp_no']}}" required="">
                                    <div class="press_enter">PRESS ENTER</div>
                                </div>
                            </div>
                            <div class="input-block select_block">
                                ...
                                <div class="input-control">
                                    <input type="text" name="type_doi_srilanka" id="type_doi_srilanka" value="{{$extractdata['pp_issue_date']}}" class="datepicker" />
                                    <div class="press_enter">PRESS ENTER</div>
                                </div>
                            </div>
                            <div class="input-block select_block">
                                ...
                                <div class="input-control">
                                    <input type="text" name="type_doe_srilanka" id="type_doe_srilanka" value="{{$extractdata['pp_expiry_date']}}" class="datepicker" />
                                    <div class="press_enter">PRESS ENTER</div>
                                </div>
                            </div>
                            <div class="input-block">
                                ...
                                <div class="input-control outerInFoc">
                                    <input type="text" placeholder="Select an option" name="gender_text" class="__select_drop inputF" value="{{$extractdata['gender_text']}}" autocomplete="off">
                                    <ul class="hiddenul">
                                        <li class="hidden_li" data-val="male">Male</li>
                                        <li class="hidden_li" data-val="female">Female</li>
                                    </ul>
                                    <input type="hidden" id="gender" name="gender" value="{{$extractdata['gender']}}" class="inputH">
                                    <div class="press_enter">PRESS TAB</div>
                                </div>
                                <div class="outerclick"></div>
                            </div>
                            <div class="input-block">
                                ...
                                <div class="input-control outerInFoc">
                                    <input type="text" placeholder="Select an option" name="nationality_dropdown_text" value="{{$extractdata['nationality']}}" class="__select_drop inputF" autocomplete="off">
                                    <ul class="hiddenul">
                                        @if(count($country_arr)>0)
                                            @foreach($country_arr as $val)
                                                <li class="hidden_li" data-val="{{$val['country_id']}}">{{$val['country_name']}}</li>
                                            @endforeach
                                        @endif
                                    </ul>
                                    <input type="hidden" id="nationality_dropdown" value="193" name="nationality_dropdown" class="inputH"> <!-- Country id is hardcoded as it is India in all the cases -->
                                    <div class="press_enter">PRESS TAB</div>
                                </div>
                                <div class="outerclick"></div>
                            </div>
                            <div class="input-block">
                                ...
                                <div class="input-control outerInFoc">
                                    <input type="text" placeholder="Select an option" name="country_of_birth_text" value="{{$extractdata['application_details']['country_of_birth_text']}}" class="__select_drop inputF" autocomplete="off">
                                    <ul class="hiddenul">
                                        @if(count($country_arr)>0)
                                            @foreach($country_arr as $val)
                                               <li class="hidden_li" data-val="{{$val['country_id']}}">{{$val['country_name']}}</li>
                                    ...
                                    <input type="hidden" id="country_of_birth" name="country_of_birth" value="{{isset($extractdata['application_details']['country_of_birth']) ? $extractdata['application_details']['country_of_birth'] : NULL}}" class="inputH">
                                    <div class="press_enter">PRESS TAB</div>
                                </div>
                                <div class="outerclick"></div>
                            </div>
                            <div class="input-block select_block">
                                ...
                                <div class="input-control">
                                    <input type="text" name="occupation" id="occupation" value = "{{isset($extractdata['application_details']['occupation']) ? $extractdata['application_details']['occupation'] : NULL}}">
                                    <div class="press_enter">PRESS ENTER</div>
                                </div>
                            </div>
                            ...
                            <div class="input-block">
                                ...
                                <div class="input-control">
                                    <input type="date" name="type_dob_srilanka" id="type_dob_srilanka" class="datepicker" value = "{{$extractdata['dob']}}" />
                                    <div class="press_enter">PRESS ENTER</div>
                                </div>
                            </div>
                            ...
                            <div class="input-block">
                                ...
                                <div class="input-control">
                                    <input type="date" name="arrival_date" id="arrival_date_srilanka" class="datepicker" value = "{{isset($extractdata['application_details']['arrival_date']) ? $extractdata['application_details']['arrival_date'] : NULL}}" />
                                    <div class="press_enter">PRESS ENTER</div>
                                </div>
                            </div>
                            <div class="input-block active">
                                ...
                                <div class="input-control">
                                    <input type="text" name="port_of_departure" id="port_of_departure" value = "{{isset($extractdata['application_details']['port_of_departure']) ? $extractdata['application_details']['port_of_departure'] : NULL}}">
                                    <div class="press_enter">PRESS ENTER</div>
                                </div>
                            </div>
                            <div class="input-block active">
                                ...
                                <div class="input-control">
                                    <input type="text" name="airline_vessel" id="airline_vessel" value = "{{isset($extractdata['application_details']['airline_vessel']) ? $extractdata['application_details']['airline_vessel'] : NULL}}">
                                    <div class="press_enter">PRESS ENTER</div>
                                </div>
                            </div>
                            <div class="input-block active">
                                ...
                                <div class="input-control">
                                    <input type="text" name="flight_vessel_number" id="flight_vessel_number" value = "{{isset($extractdata['application_details']['airline_vessel_no']) ? $extractdata['application_details']['airline_vessel_no'] : NULL}}" >
                                    <div class="press_enter">PRESS ENTER</div>
                                </div>
                            </div>
                            <div class="input-block tourist"> <!-- this purpose of visit is for Tourist travellers -->
                                ...
                                <div class="input-control outerInFoc">
                                    ...
                                    <ul class="hiddenul">
                                        ...
                                        <li class="hidden_li" data-val="{{$val->purpose_id}}">{{$val->purpose_name}}</li>
                                        @endforeach
                                    </ul>
                                    <input type="hidden" id="purpose_of_visit" name="purpose_of_visit_tourist" class="inputH">
                                    <div class="press_enter">PRESS TAB</div>
                                </div>
                                <div class="outerclick"></div>
                            </div>
                            <div class="input-block business"> <!-- this purpose of visit is for Business travellers -->
                                ...
                                <div class="input-control outerInFoc">
                                    ...
                                    <input type="hidden" id="purpose_of_visit" name="purpose_of_visit_business" class="inputH">
                                    <div class="press_enter">PRESS TAB</div>
                                </div>
                                <div class="outerclick"></div>
                            </div>
                            ...
                            <div class="input-block transit"> <!-- this purpose of visit is for Transit travellers -->
                                ...
                                <div class="input-control outerInFoc">
                                    ...
                                    <ul class="hiddenul">
                                        @foreach($gettransitpurpose as $val)
                                        <li class="hidden_li" data-val="{{$val->purpose_id}}">{{$val->purpose_name}}</li>
                                        @endforeach
                                    </ul>
                                    <input type="hidden" id="purpose_of_visit" name="purpose_of_visit_transit" class="inputH">
                                    <div class="press_enter">PRESS TAB</div>
                                </div>
                                <div class="outerclick"></div>
                            </div>
