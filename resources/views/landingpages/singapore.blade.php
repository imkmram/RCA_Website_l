        ...
        <div class="container container-sm paddingtb_50">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h1 class="__heading">Apply for Singapore eVisa.</h1>
                ...
                <div class="col-md-offset-2 col-md-8 col-md-offset-2">
                    <form name="LP_LeadForm" method="post" action="https://www.redcarpetassist.com/send_leadfrm_ab.php" method="POST" id="LP_LeadForm" novalidate="novalidate" class="LP_LeadForm">
                        <!-- hidden Field CRM -->
                        <input type="hidden" name="destination" value="Singapore">
                        ...
                        <div class="__lead_form">
                            ...
                            <div class="col-md-12">
                                <p class="__select_label" id="e_service">Select Singapore Visa Type</p>
                            </div>
                            <div class="__radio_row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="group-radio">
                                        <input id="s1" name="service_type" type="radio" class="orbit" value="TouristMultipleEntrySingapore" />
                                        <label for="s1">30 Days Tourist eVisa</label>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <div class="group-radio">
                                        <input id="s2" name="service_type" type="radio" class="orbit" value="BusinessMultipleEntrySingapore"/>
